...
const Services = () => {
    return (
        <section className=" bg-pink-50 flex flex-col items-center mx-4 px-3 sm:px-6">
        <div className="w-full max-w-[1100px]">
            ...
            {/* Table header */}
            <div className="grid grid-cols-3 font-serif text-[#3c2a1e] pb-3">
            ...
            <div className="w-full bg-white grid grid-cols-3 gap-2 py-6  text-[#4b3b30] mb-5">
                <p className="font-serif m-auto ml-3">Consultation</p>
                <p className="text-sm text-gray-500 leading-5 -ml-6 -mr-12">
                ...
                <p className="font-serif text-[#3c2a1e] ml-12 m-auto">£20</p>
            </div>


            
            <div className="w-full bg-white py-3 text-[#4b3b30] mb-8">
                <p className="mx-3 font-serif text-[#3c2a1e] border-b-gray-400 border-b-1 leading-8">Starter Locs</p>
                <div className=" bg-white grid grid-cols-3 gap-2 py-6 text-[#4b3b30] mb-2 ">
                    <p className="font-serif m-auto ml-3">Comb coil full head</p>
                    <p className="text-sm text-gray-500 leading-5 -ml-6 -mr-12">
                    ...
                    <p className="font-serif text-[#3c2a1e] ml-12 m-auto"><span className="font-serif text-xs text-gray-500">from</span>£200</p>
                </div>
                <hr className="mx-3 border-gray-400"/>
                
                <div className=" bg-white grid grid-cols-3 gap-2 py-3 text-[#4b3b30] mb-2 ">
                    ...
                    <p className="font-serif text-[#3c2a1e] ml-12 m-auto">£500</p>
                </div>
                <hr className="mx-3 border-gray-400"/>
                <div className=" bg-white grid grid-cols-3 gap-2 py-3 text-[#4b3b30] mb-2 ">
                    ...
                    <p className="font-serif text-[#3c2a1e] ml-12 m-auto">£400</p>
                </div>
            </div>
            ...
            <div className="w-full bg-white py-3 text-[#4b3b30] mb-8">
                ...
                <div className=" bg-white grid grid-cols-3 gap-2 py-6 text-[#4b3b30] mb-2 ">
                    ...
                    <p className="font-serif text-[#3c2a1e] ml-12 m-auto">£30</p>
                </div>
                <hr className="mx-3 border-gray-400"/>
            ...
            <div className=" bg-white grid grid-cols-3 gap-2 py-3 text-[#4b3b30] mb-8">
                ...
                <p className="font-serif text-[#3c2a1e] ml-12 m-auto">£40</p>
            </div>
            <div className=" bg-white grid grid-cols-3 gap-2 py-3 text-[#4b3b30] mb-8">
            ...
            <div className="w-full bg-white py-3 text-[#4b3b30] mb-8">
                ...
                <div className=" bg-white grid grid-cols-3 gap-2 py-6 text-[#4b3b30] mb-2 ">
                    ...
                    <p className="font-serif text-[#3c2a1e] ml-12 m-auto">£80<span className="font-serif text-xs text-gray-500"> Style</span></p>
                </div>
                <hr className="mx-3 border-gray-400"/>
                ...
                <div className=" bg-white grid grid-cols-3 gap-2 py-3 text-[#4b3b30] mb-2 ">
                    ...
                    <p className="font-serif text-[#3c2a1e] ml-12 m-auto">£70<span className="font-serif text-xs text-gray-500"> Style</span></p>
                </div>
                <hr className="mx-3 border-gray-400"/>
                <div className=" bg-white grid grid-cols-3 gap-2 py-3 text-[#4b3b30] mb-2 ">
                    <p className="font-serif m-auto ml-3">Sister Locs</p>
                    ...
                    <p className="font-serif text-[#3c2a1e] ml-12 m-auto">£150<span className="font-serif text-xs text-gray-500"> Style</span></p>                    
                </div>
                <hr className="mx-3 border-gray-400"/>
                ...
                <div className=" bg-white grid grid-cols-3 gap-2 py-3 text-[#4b3b30] mb-8 ">
                    ...
                    <p className="font-serif text-[#3c2a1e] ml-12 m-auto">£130<span className="font-serif text-xs text-gray-500"> Style</span></p>
                </div>             
            </div>
            <div className="w-full bg-white py-3 text-[#4b3b30] mb-2">
                ...
                <div className=" bg-white grid grid-cols-3 gap-2 py-3 text-[#4b3b30]">
                    <p className="font-serif m-auto ml-3">Half head</p>
                    <p className="text-sm text-gray-500 leading-5 -ml-6 -mr-12">
                    ...
                    <p className="font-serif text-[#3c2a1e] ml-12 m-auto">£60<span className="font-serif text-xs text-gray-500"> Style</span></p>
                </div>
            </div>
